...
[![NPM Package](https://img.shields.io/npm/v/neobytescore-lib.svg?style=flat-square)](https://www.npmjs.org/package/neobytescore-lib)
...
```
npm install @neobytes/neobytescore-lib
```
