...
# Governance Object
A Governance Object (or "govObject") is a generic structure introduced in Neobytes Core v12.1 to allow for the creation of Budget Proposals, Triggers, and Watch Dogs. Class inheritance has been utilized to extend this generic object into a "Proposal" which is outlined throughout the remainder of this document. 
...
####  `checkedSerialize`
Return an hexa string that can be used in neobytesd CLI
####  `serialize`
...
var jsonProposal = {
  ...
  url:"http://www.neobytes.network/proposal/first_proposal"
};
...
```javascript
proposal.url="http://neobytes.network/badUrl"
var shallowCopyProposal = proposal.shallowCopy();
proposal.url="http://neobytes.network/fixedUrl"
