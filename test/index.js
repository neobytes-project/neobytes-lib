...
describe('#versionGuard', function() {
  ...
  it('throw a warning if version is already defined', function() {
      ...
      should.equal(console.warn.calledWith('More than one instance of neobytescore-lib found. Please make sure that you are not mixing instances of classes of the different versions of bitcore.'),true)
  });
});
